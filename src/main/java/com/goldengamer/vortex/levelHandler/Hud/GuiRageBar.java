...
public class GuiRageBar extends Event
{
    ...
    public void onRenderGameOverlay(RenderGameOverlayEvent event)
    {
        if (!event.isCancelable() && event.type == RenderGameOverlayEvent.ElementType.EXPERIENCE) {
            ...
            //this checks if the item is a instanceof IWarrior
            if (currentItemStack != null && currentItemStack.getItem() instanceof IWarrior && !currentItemStack.getTagCompound().getString("ownerName").equals("")) {
