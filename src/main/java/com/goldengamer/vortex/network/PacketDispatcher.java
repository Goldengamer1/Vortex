...
public class PacketDispatcher
{
    ...
    {
        //PacketDispatcher.registerMessage("Class"."ClassHandler".class, "Class".class, "Side .SERVER OR .CLIENT");
        //PacketDispatcher.registerMessage(MessageSyncPlayerProps.SyncPlayerPropsMessageHandler.class, SyncPlayerPropsMessage.class, Side.CLIENT);
    }
